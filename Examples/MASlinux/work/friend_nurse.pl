...
eve(what_about_lung_doc(var_Patient)):-name(var_Name),best_doc,chosen_ld(var_Lung_doc,var_X),a(message(var_Patient,send_message(friend_opinion(var_Name,var_Lung_doc,var_X),var_Name))),retractall(chosen_ld(var__)),write('Io consiglio il dottore '),write(var_Lung_doc),write(', su di lui ho una fiducia di '),write(var_X),nl.

best_doc:-clause(ability(lung_doc1,var_X1),var__),clause(ability(lung_doc2,var_X2),var__),if(var_X2>var_X1,assert(chosen_ld(lung_doc2,var_X2)),assert(chosen_ld(lung_doc1,var_X1))).
...
call_confirm(var_X,var_Ag,var_T):-ground(var_X),statistics(walltime,[var_Tp,var__]),datime(_163233),retractall(evtp_date(var_X,_163241)),assert(evtp_date(var_X,_163233)),asse_cosa(past_event(var_X,var_T)),retractall(past(var_X,var_Tp,var_Ag)),assert(past(var_X,var_Tp,var_Ag)).
...
call_inform(var_X,var_Ag,var_M,var_T):-asse_cosa(past_event(inform(var_X,var_M,var_Ag),var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(inform(var_X,var_M,var_Ag),var__,var_Ag)),assert(past(inform(var_X,var_M,var_Ag),var_Tp,var_Ag)),datime(_163078),retractall(evtp_date(inform(var_X,var_M,var_Ag),_163086)),assert(evtp_date(inform(var_X,var_M,var_Ag),_163078)).

call_inform(var_X,var_Ag,var_T):-asse_cosa(past_event(inform(var_X,var_Ag),var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(inform(var_X,var_Ag),var__,var_Ag)),assert(past(inform(var_X,var_Ag),var_Tp,var_Ag)),datime(_162996),retractall(evtp_date(inform(var_X,var_Ag),_163004)),assert(evtp_date(inform(var_X,var_Ag),_162996)).

call_refuse(var_X,var_Ag,var_T):-clause(agent(var_A),var__),asse_cosa(past_event(var_X,var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(var_X,var__,var_Ag)),assert(past(var_X,var_Tp,var_Ag)),a(message(var_Ag,reply(received(var_X),var_A))),datime(_162924),retractall(evtp_date(var_X,_162932)),assert(evtp_date(var_X,_162924)).

call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_162813,var_Ontology,_162815),_162810),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_162832)),a(message(var_Ag,propose(var_A,[_162832],var_AgI))),retractall(ext_agent(var_Ag,_162851,var_Ontology,_162853)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_162750,var_Ontology,_162752),_162747),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_162785,var_Ontology,_162787)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_162694,var_Ontology,_162696),_162691),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_162722,var_Ontology,_162724)).

call_accept_proposal(var_A,var_Mp,var_Ag,var_T):-asse_cosa(past_event(accepted_proposal(var_A,var_Mp,var_Ag),var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(accepted_proposal(var_A,var_Mp,var_Ag),var__,var_Ag)),assert(past(accepted_proposal(var_A,var_Mp,var_Ag),var_Tp,var_Ag)),datime(_162647),retractall(evtp_date(accepted_proposal(var_A,var_Mp,var_Ag),_162655)),assert(evtp_date(accepted_proposal(var_A,var_Mp,var_Ag),_162647)).

call_reject_proposal(var_A,var_Mp,var_Ag,var_T):-asse_cosa(past_event(rejected_proposal(var_A,var_Mp,var_Ag),var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(rejected_proposal(var_A,var_Mp,var_Ag),var__,var_Ag)),assert(past(rejected_proposal(var_A,var_Mp,var_Ag),var_Tp,var_Ag)),datime(_162563),retractall(evtp_date(rejected_proposal(var_A,var_Mp,var_Ag),_162571)),assert(evtp_date(rejected_proposal(var_A,var_Mp,var_Ag),_162563)).

call_failure(var_A,var_M,var_Ag,var_T):-asse_cosa(past_event(failed_action(var_A,var_M,var_Ag),var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(failed_action(var_A,var_M,var_Ag),var__,var_Ag)),assert(past(failed_action(var_A,var_M,var_Ag),var_Tp,var_Ag)),datime(_162479),retractall(evtp_date(failed_action(var_A,var_M,var_Ag),_162487)),assert(evtp_date(failed_action(var_A,var_M,var_Ag),_162479)).

call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_162389),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_162406),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_162297).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_162221),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_162195),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_162133,_162134)),clause(agente(_162144,_162145,_162146,var_S),_162142),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_162030,_162031,_162032,var_S),_162028),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_162080,[]),repeat,read(_162080,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_162080).
