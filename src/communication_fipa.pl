...
call_query_ref(var_X,var_N,var_Ag):-clause(agent_x(var_A),var__),not(var(var_X)),meta_ref(var_X,var_N,var_L,var_Ag),a(message(var_Ag,inform(query_ref(var_X,var_N),values(var_L),var_A))).

call_query_ref(var_X,var__,var_Ag):-clause(agent_x(var_A),var__),var(var_X),a(message(var_Ag,refuse(query_ref(variable),motivation(refused_variables),var_A))).

call_query_ref(var_X,var_N,var_Ag):-clause(agent_x(var_A),var__),not(var(var_X)),not(meta_ref(var_X,var_N,var__,var__)),a(message(var_Ag,inform(query_ref(var_X,var_N),motivation(no_values),var_A))).

call_agree(var_X,var_Ag):-clause(agent_x(var_A),var__),ground(var_X),meta_agree(var_X,var_Ag),a(message(var_Ag,inform(agree(var_X),values(yes),var_A))).
...
call_agree(var_X,var_Ag):-clause(agent_x(var_A),var__),ground(var_X),not(meta_agree(var_X,var__)),a(message(var_Ag,inform(agree(var_X),values(no),var_A))).

call_agree(var_X,var_Ag):-clause(agent_x(var_A),var__),not(ground(var_X)),a(message(var_Ag,refuse(agree(variable),motivation(refused_variables),var_A))).
...
call_refuse(var_X,var_Ag,var_T):-clause(agent_x(var_A),var__),asse_cosa(past_event(var_X,var_T)),statistics(walltime,[var_Tp,var__]),retractall(past(var_X,var__,var_Ag)),assert(past(var_X,var_Tp,var_Ag)),a(message(var_Ag,reply(received(var_X),var_A))).


call_cfp(var_A,var_C,var_Ag):-clause(agent_x(var_AgI),var__),
                                  clause(ext_agent_x(var_Ag,_,var_Ontology,_),_),
                                  ...
                                  retractall(ext_agent_x(var_Ag,_,var_Ontology,_)).




call_propose(var_A,var_C,var_Ag):-clause(agent_x(var_AgI),var__),
                                  clause(ext_agent_x(var_Ag,_,var_Ontology,_),_),
                                  asserisci_ontologia(var_Ag,var_Ontology,var_A),
...
evi(external_refused_action_propose(var_A,var_Ag)):-clause(agent_x(var_Ai),var__),
...
evi(refused_message(var_AgM,var_Con)):-clause(agent_x(var_Ai),var__),
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent_x(var_Ag),_),a(message(var_S, send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).
