...
%%%%%%%%%%%
%% Procedure loop that keeps the user agent_x continuously active and waiting for user interaction. 
...
% writes on the backboard that the agent_x 'user' is active and calls the
