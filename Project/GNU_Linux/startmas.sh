...
clear # cls
#title "MAS"
sicstus_home=/usr/local/sicstus4.3.2
main_home=../..
dali_home=../../src
conf_dir=conf
...
xterm -hold -e "rlwrap $prolog -l $dali_home/active_user_wi.pl --goal utente." & # start /B "" "%prolog%" -l "%dali_home%/active_user_wi.pl" --goal utente.
