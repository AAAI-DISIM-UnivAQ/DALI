...
eve(alliance_proposal(var_A)):-agent(var_X),default_bid_value(var_V),a(message(var_A,send_message(alliance_accepted(var_V),var_X))),write('alliance ;)'),nl.

eve(new_auction(var_N)):-retract(n_auction(var__)),assert(n_auction(var_N)),bid(var_N).

bid(var_N):-evp(alliance_proposal(var_X)),agent(var_M),a(message(auctioneer,send_message(place_bid(0,var_M,var_N),var_M))),write(' bidded '),write('0').

bid(var_N):-default_bid_value(var_V),agent(var_M),a(message(auctioneer,send_message(place_bid(var_V,var_M,var_N),var_M))),write(' bidded '),write(var_V).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_360433,var_Ontology,_360437),_360427),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_360471)),a(message(var_Ag,propose(var_A,[_360471],var_AgI))),retractall(ext_agent(var_Ag,_360509,var_Ontology,_360513)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_360307,var_Ontology,_360311),_360301),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_360377,var_Ontology,_360381)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_360195,var_Ontology,_360199),_360189),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_360251,var_Ontology,_360255)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_359759),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_359793),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_359575).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_359423),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_359371),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_359247,_359249)),clause(agente(_359269,_359271,_359273,var_S),_359265),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_359041,_359043,_359045,var_S),_359037),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_359141,[]),repeat,read(_359141,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_359141).
